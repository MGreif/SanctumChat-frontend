...
export class MessageEventSubscriber {
  ...
  public setFriendRequestMessageReceive(
    handler: (message: TMessageFriendRequest) => void
  ) {
  ...
  public setNotficationMessageReceive(
    handler: (message: TMessageNotification) => void
  ) {
  ...
  public setFriendStatusChangeMessageReceive(
    handler: (message: TMessageStatusChange) => void
  ) {
  ...
  public setInitialOnlineFriendsReceive(
    handler: (message: TMessageInitialOnlineUsers) => void
  ) {
