type TYPE =
  | 'SOCKET_MESSAGE_DIRECT'
  | 'SOCKET_MESSAGE_NOTIFICATION'
  | 'SOCKET_MESSAGE_EVENT'
  | 'SOCKET_MESSAGE_ONLINE_USERS'
  | 'SOCKET_MESSAGE_STATUS_CHANGE'
  | 'SOCKET_MESSAGE_FRIEND_REQUEST'
...
export type TMessage = { TYPE: TYPE } & (
  | TMessageDirect
